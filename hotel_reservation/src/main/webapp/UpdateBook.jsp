...
<html lang="en">
   ...
   <body class="main-layout">
         ...
         <div class="booking_ocline">
            <div class="container">
               <div class="row">
                  <div class="col-md-5">
                     <div class="book_room">
                        <h1>Update Your Booking Details Here</h1>
                        <%
	...
	%>
                        <form class="book_now" action = "bupdate" method = "post">
                           <div class="row">
                           <div class="col-md-12">
                                 <span>ID</span>
                              ...
                              <div class="col-md-12">
                                 <span>Package</span>
                                 <input type="text" class="form-control form-control-sm" name="packages" value="<%= packages %>">
                              </div>
                              <div class="col-md-12">
                              <img class="date_cua" src="images/date.png">
                                 <span>Arrival</span>
                                 <input type="date" class="online_book" name="arrival" value="<%= arrival %>">
                              </div><div class="col-md-12">
                              <img class="date_cua" src="images/date.png">
                                 <span>Departure</span>
                                 <input type="date" class="online_book" name="depature" value="<%= depature %>">
                              </div>
