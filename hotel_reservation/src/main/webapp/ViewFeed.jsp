         ...
         <div class="booking_ocline">
            <div class="container">
               <div class="row">
                  <div class="col-md-5">
                     <div class="book_room">
                        <h1>Check Your Feedback Details Here</h1>
                        <form class="book_now">
                           <div class="row">
                           ...
                           <div class="col-md-12">
                                 <span>ID</span>
                                 <input class="form-control form-control-sm" value="${feed.id}" readonly>
                              </div>
                              <div class="col-md-12">
                                 <span>Name</span>
                                 <input class="form-control form-control-sm" value="${feed.name}" readonly>
                              </div>
                              <div class="col-md-12">
                                 <span>Feedback</span>
                                 <input class="form-control form-control-sm" value="${feed.feedback}" readonly>
                              </div>
                              <br></br>
                               <br></br>
                              </c:forEach>
                              ...
                              <c:url value="UpdateFeed.jsp" var="FeedbackUpdate">
                        ...
                        <div class="col">
                          <a href="${FeedbackUpdate}"><input type = "button" class="book_btn" value = "Edit Details"></a>
                        </div>
                        ...
                        <div class="col">
                       <a href="${FeedbackDelete}"><input type = "button" class="book_btn" value = "Delete Feedback"></a>
                        </div>
                     </div>
                  </div>
               </div>
