         ...
         <div class="booking_ocline">
            <div class="container">
               <div class="row">
                  <div class="col-md-5">
                     <div class="book_room">
                        <h1>Delete Your Feedback Here</h1>
                        <%
		String id = request.getParameter("id");
		String name = request.getParameter("name");
		String feedback = request.getParameter("feedback");
	%>
                        <form class="book_now" action = "fdelete" method = "post">
                           <div class="row">
                           <div class="col-md-12">
                                 <span>ID</span>
                              ...
                              <div class="col-md-12">
                                 <span>Feedback</span>
                                 <input type="text" class="form-control form-control-sm" name="feedback" value="<%= feedback %>" readonly>
                              </div>
                              <br></br>
                               <br></br>
                              <div class="col-md-12">
                              <div class="row">
                           <div class="col">
                                 <input type = "submit" class="book_btn" value = "Delete Feedback">
                              </div>
