         ...
         <div class="booking_ocline">
            <div class="container">
               <div class="row">
                  <div class="col-md-5">
                     <div class="book_room">
                        <h1>Update Your Feedback Details Here</h1>
                        <%
		String id = request.getParameter("id");
		String name = request.getParameter("name");
		String feedback = request.getParameter("feedback");
	%>
                        <form class="book_now" action = "fupdate" method = "post">
                           <div class="row">
                           <div class="col-md-12">
                                 <span>ID</span>
                              ...
                              <div class="col-md-12">
                                 <span>Feedback</span>
                                 <input type="text" class="form-control form-control-sm" name="feedback" value="<%= feedback %>">
                              </div>
