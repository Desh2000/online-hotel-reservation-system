...
<html lang="en">
   ...
   <body class="main-layout">
         ...
         <div class="booking_ocline">
            <div class="container">
               <div class="row">
                  <div class="col-md-5">
                     <div class="book_room">
                        <h1>Update Your Inquiry Details Here</h1>
                        <%
	...
	%>
                        <form class="book_now" action = "cupdate" method = "post">
                           <div class="row">
                           <div class="col-md-12">
                                 <span>ID</span>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <span>Message</span>
                                 <input type="text" class="form-control form-control-sm" name="message" value="<%= message %>">
                              </div>
